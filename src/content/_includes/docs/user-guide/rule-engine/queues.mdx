...
- **Kafka** — distributed, durable, and production-ready. Messages survive service restarts.
  Best for high throughput and fault-tolerant deployments.
- **In-Memory** — lightweight and fast. Messages are lost on restart. Best for development
  or small-scale environments.
