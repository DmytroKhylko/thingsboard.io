...
import step1 from '~/assets/images/delete-domain-step-1.png'
import step2 from '~/assets/images/delete-domain-step-2.png'
...
<ImageGallery
  images={[
    { src: step1, alt: 'Delete domain — step 1', caption: 'Step 1: open domain settings' },
    { src: step2, alt: 'Delete domain — step 2', caption: 'Step 2: confirm deletion' },
  ]}
/>
